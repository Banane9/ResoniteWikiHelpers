...
";
        ...
        private static void Main(string[] args)
        {
            ...
            writer.Write(string.Format(_cssTemplate, "SyncOperation", ColorXToString(DatatypeColorHelper.GetOperationColor(false))));
            writer.Write(string.Format(_cssTemplate, "AsyncOperation", ColorXToString(DatatypeColorHelper.GetOperationColor(true))));
